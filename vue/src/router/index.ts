    ...
    },
    {
        ...
        children: [
...

            {
                ...
                component: () => import(/* webpackChunkName: "publish" */ '../views/brand.vue'),
            },

            {
                ...
                component: () => import(/* webpackChunkName: "book" */ '../views/car.vue'),
            },
            {
                path: '/rent',
                name: 'rent',
                ...
                component: () => import(/* webpackChunkName: "book" */ '../views/rent.vue'),
            },
            {
                path: '/my_order',
                name: 'my_order',
                ...
                component: () => import(/* webpackChunkName: "book" */ '../views/my_order.vue'),
            }, {
                path: '/collection',
                name: 'collection',
                meta: {
                ...
                component: () => import(/* webpackChunkName: "book" */ '../views/my_collection.vue'),
            },
            {
                path: '/comment',
                name: 'comment',
                ...
                component: () => import(/* webpackChunkName: "role" */ '../views/comment.vue'),
            },
            {
                path: '/role',
                name: 'role',
