  ...
  <div>
    <div class="container">
      ...
      <el-table :data="filteredData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
        ...
        <el-table-column prop="permission_ids" label="权限列表" align="center"></el-table-column>
...
import TableEdit from './role-edit.vue';
...
const handlePageChange = async(newPage: number) => {
  ...
  try {
          const response = await postRequest(route.fullPath + '/query', {query_string:searchKey.value,page: currentPage.value,size:pageSize.value});
          console.log("分页查询");
