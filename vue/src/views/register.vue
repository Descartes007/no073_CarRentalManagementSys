...
import {Lock, User, Iphone, Phone} from '@element-plus/icons-vue';
import {postRequest} from '../api/index';
import {isRequired, checkEmail, checkPassword, checkPhone} from '../utils/validations';
...
const rules: FormRules = {
  ...
  phone: [{required: true, message: '请输入电话号码', trigger: 'blur'},{ validator: checkPhone, trigger: 'blur' },],
};
